...
document.getElementById("currentdice").addEventListener("click", () => {
  ...
  if (dice !== 1) {
    ...
    // document.getElementById("col1").style.backgroundColor = "#AED6F1";
    value += dice;
    a.innerHTML = value;
  } else {
    if (active == 0) {
      ...
      // document.getElementById("col2").style.backgroundColor = "#AED6F1";
      // document.getElementById("col1").style.backgroundColor = "#D6DBDF";
      ...
      document.getElementById("player_current-" + active).innerHTML = score[active];
      // document.getElementById("col1").style.backgroundColor = "#AED6F1";
      // document.getElementById("col2").style.backgroundColor = "#D6DBDF";
